...
class SimpleNLG:
    ...
    def importsimplenlg(self):
        """
        imports the SimpleNLG through the use of Py4j (enables Python programs to dynamically access Java objects)
        and initializes the SimpleNLG classes and objects
        """
