...
function main() {
    ! function() {
        ...
        $(window).load(function() {
            ...
            o("span.count").length > 0 && o("span.count").counterUp({
                delay: 10,
                time: 1500
            })
        })
...
main(), $(function() {
    ! function() {
        ...
        jQuery("#gallery").photobox(".photobox_a"), jQuery("#gallery").photobox(".photobox_a:first", {
            thumbs: !1,
            time: 0
        }, o)
    }()
    ...
    $(function() {
        ...
        }), $(".scroll-top-wrapper").on("click", o)
    })
});
var typed3 = new Typed("#typed3", {
    strings: ["The Foodie", "The Fangirl/Fanboy", "The Melancholic"],
    typeSpeed: 50,
    backSpeed: 30,
    smartBackspace: !0,
    loop: !0
