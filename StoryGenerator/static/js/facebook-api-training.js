...
$(document).on("click", "#loginFB", function() {
    FB.login(function(response) {
        if (response.authResponse) {
            console.log('Yoooo Welcome!  Fetching your information.... ');
...
//            console.log("Access Token: " + accessToken);
            ...
            FB.api('/me', function(response) {
			    ...
			    //Get Posts, Likes, Events for Training
                FB.api(
                    '/me',
                    'GET',
                    {"fields":"posts.limit(5000){story,description,message,updated_time},likes.limit(5000){name,category,about,description},events.limit(5000){name,description,rsvp_status}"},
                    getPosts
                )
            });
    ...
    function storeToDb(){
        ...
        $.ajax({
            ...
            success: function (data) {
                alert("Post, likes, and events successfully extracted. Thank you!");
            }
        });
    }
