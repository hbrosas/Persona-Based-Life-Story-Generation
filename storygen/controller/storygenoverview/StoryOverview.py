    ...
    def workphrase(self, works):
        if len(works) != 0:
            ...
            for w in works:
                ...
                enddate = w.enddate
                position = w.position
                if startdate != "0000-00" and startdate != "0000-00-00" and startdate is not None:
                    startdateformat = datetime.strptime(startdate, '%Y-%m-%d').date()
                    startdate = startdateformat.strftime("%B %Y")
                # print(startdate)

                if enddate != "0000-00" and enddate != "0000-00-00" and enddate is not None:
                ...
                if startdate is not None and startdate != "" and startdate != "0000-00" and startdate != "0000-00-00":
                ...
                if enddate is not None and enddate != "" and enddate != "0000-00" and enddate != "0000-00-00":
